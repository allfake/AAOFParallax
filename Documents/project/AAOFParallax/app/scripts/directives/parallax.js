...
angular.module('parallaxApp')
  .directive('parallax', function ($window, $timeout) {
    return {
      ...
      template: '<div class="parallax-bg" ng-style="backgroundImagePosition" style="background-image:url(images/{{imageSrc}}); height:{{imageHeight}}px"></div><div class="parallax-story" max-height="{{windowHeight}}px" ng-transclude></div>',
